...
const Getofffer = () => {
        const upiid = "mab.037324047250098@axisbank";
        ...
        const openGpay = (price) => {
            if (price > 0) {
                ...
                const supportedInstruments = [{
                    ...
                    data: {
                        pa: upiid, // Replace with your Merchant UPI ID
        ...
        return ( <
                ...
                div className = "flex items-center" > {
                    ...
                    <
                    img src = {
                        localStorage.np === "jio" ? Jio : localStorage.np === "airtel" ? Airtel : localStorage.np === "vi" ? Vi : localStorage.np === "bsnl" ? Bsnl : Jio
                    }
                    alt = ""
...

                {
                    ...
                    <
                    svg className = "mx-auto mb-4 text-gray-400 w-12 h-12"
                    aria - hidden = "true"
                    xmlns = "http://www.w3.org/2000/svg"
                    fill = "none"
                    viewBox = "0 0 20 20" >
                    ...
                    <
                    /svg> <
                    h3 className = "mb-5 text-lg font-normal text-gray-500" > Technical Error!!Your Money will be refunded within 24 hrs < /h3> <
                    button type = "button"
                    onClick = {
                        () => openGpay()
                    }
                    ...
                    /div>} {
                        ...
                        className = "py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100" > Close < /button> <
                            /div> <
                            /div> <
                            /div> <
                            /div>}
