...
const Home = () => {
        ...
        return ( <
            ...
            <
            div className = "text-blue-500 flex items-center text-[17px] font-bold w-fit mx-auto mb-8" > < RiSmartphoneFill size = {
                30
            }
            ...
            <
            div className = "border-2 border-blue-500 rounded px-2 py-1" > < input type = "radio"
            id = "jio"
            name = "r1"
            value = "jio"
            onChange = {
            ...
            /><label for="airtel">Airtel</label > < /div> <
            div className = "border-2 border-blue-500 rounded px-2 py-1" > < input type = "radio"
            id = "vi"
            name = "r1"
            value = "vi"
            ...
            required / > {
                ...
                className = "bg-blue-500 py-3 w-full text-[15px] rounded-xl font-bold text-white" > Recharge < /button> <
                /div> <
                /div> <
                /div> <
                img src = {
